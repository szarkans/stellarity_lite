...
This is a **fork** of [Stellarity](https://modrinth.com/datapack/stellarity) made by **kohara** - datapack that completely rehauls **The End**.  
...
## Help
If you need help with **this** version of Stellarity - contact me at:  
- `@szarkans` at Discord  
- `@szarkan` at Telegram
...
Known bugs as of `3.0.5.7` version:  
...
Know any other bugs? Contact `@szarkans` at Discord or `@szarkan` at Telegram.
</details>

![Preview](https://cdn.modrinth.com/data/bZgeDzN8/images/b77957d0f75bfb1484e0f5d27fa01ade76217d45.png)
...
<details>
<summary>Partialy incompatible</summary>
