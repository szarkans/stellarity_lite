...
# Detonation
execute unless score @s stellarity.items.prismatic_punch.piercing_cooldown matches 1.. anchored eyes if entity @n[type=!#kohara:invalid_targets,dx=0,predicate=!stellarity:items/holding/prismatic_punch] run function stellarity:items/prismatic_punch/detonate/start
execute unless score #exploded stellarity.misc matches 1 unless score @s stellarity.items.prismatic_punch.piercing_cooldown matches 1.. anchored eyes if entity @n[type=!#kohara:invalid_targets,distance=..2.5,predicate=!stellarity:items/holding/prismatic_punch] run function stellarity:items/prismatic_punch/detonate/start
