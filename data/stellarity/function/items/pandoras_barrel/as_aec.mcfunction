scoreboard players operation @s stellarity.misc = @n[type=armor_stand,tag=stellarity.pandoras_barrel.armor_stand] stellarity.items.pandoras_barrel.animation
