...
function kohara:reduce_by_percent {holder:"@s",score:"stellarity.items.spectral_fury.damage",percent:30}
...
execute if score @s stellarity.items.spectral_fury.pierce_count matches 4 run function stellarity:items/spectral_fury/wisp/remove
