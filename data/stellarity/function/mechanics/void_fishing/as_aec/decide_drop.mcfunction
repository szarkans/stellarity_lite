...
execute if score #catch.fisher_of_voids stellarity.misc matches 1 if score #catch.pufferfish stellarity.misc matches 0 run loot spawn ~ ~ ~ loot stellarity:items/tools/fisher_of_voids
