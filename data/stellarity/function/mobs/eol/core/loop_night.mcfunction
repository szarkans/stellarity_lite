...
execute if score @s stellarity.eol.hurt_time matches 1 as @n[type=armor_stand,tag=stellarity.eol.as] at @s run function stellarity:mobs/eol/core/model/normal
