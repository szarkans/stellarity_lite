...
execute if score @s stellarity.eol.animation matches 125 as @n[type=vindicator,tag=stellarity.eol] at @s run playsound minecraft:entity.vex.charge hostile @a[distance=0..] ~ ~1 ~ 1.5 0.8

execute if score @s stellarity.eol.animation matches 101..145 as @n[type=vindicator,tag=stellarity.eol] at @s run tp @s ~ ~-0.015 ~
execute if score @s stellarity.eol.animation matches 145..155 as @n[type=vindicator,tag=stellarity.eol] at @s run tp @s ~ ~-0.01 ~
...
execute if score @s stellarity.eol.animation matches 165 run data merge entity @n[type=vindicator,tag=stellarity.eol] {Invulnerable:0b}
execute if score @s stellarity.eol.animation matches 165 run tag @n[type=vindicator,tag=stellarity.eol] add stellarity.eol.can_attack
